...
import com.lenovo.smarttraffic.cehua.SlidViewFragment;
import com.lenovo.smarttraffic.cehua2.Fragment17;
import com.lenovo.smarttraffic.fragment.Fragment02;
import com.lenovo.smarttraffic.fragment.Fragment04;
import com.lenovo.smarttraffic.fragment.Fragment20;
...
//        position = index;
    ...
    private void initView() {
        ...
        text_var=findViewById(R.id.text_bar);
        text_var.setText("主页");
        ...
        switch (id){
           ...
           /* case R.id.item_15:
            ...
            case R.id.item_16:
                ...
                break;
            case R.id.item_20:
                Intent intent=new Intent(this,MainAcwtivity1.class);
                startActivity(intent);*/
                //Fragment20 fragment20=new Fragment20();
                //fragmentManager.beginTransaction().replace(R.id.container,fragment20 ).commit();
               /* break;*/
            case R.id.item_21:
                /*SlidViewFragment slidViewFragment=new SlidViewFragment();
                fragmentManager.beginTransaction().replace(R.id.container, slidViewFragment).commit();*/
                Fragment17 fragment17=new Fragment17();
                fragmentManager.beginTransaction().replace(R.id.container, fragment17).commit();
